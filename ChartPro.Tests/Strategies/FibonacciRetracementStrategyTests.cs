...
public class FibonacciRetracementStrategyTests
{
    private readonly FibonacciRetracementStrategy _strategy;
    private readonly Plot _plot;

    public FibonacciRetracementStrategyTests()
    {
        _strategy = new FibonacciRetracementStrategy();
        _plot = new Plot();
    }

    [Fact]
    public void CreatePreview_ShouldReturnLine_WithGoldColor()
    {
        // Arrange
    ...
    [Fact]
    public void CreateFinal_ShouldReturnLine_WithGoldColor()
    {
        // Arrange
        var start = new Coordinates(10, 20);
        var end = new Coordinates(30, 40);
